                ...
                <div className="row pb-3">
                    ...
                    <div className="col-xl-3 col-md-6 py-3">
                        <div className="card h-100">
                            <img className="card-img-top custom-image" src="images/libros.jpg" alt="Adjudicadas becas libros curso 2023 / 2024" />
                    ...
                    <div className="col-xl-3 col-md-6 py-3">
                        <div className="card h-100">
                            <img className="card-img-top custom-image" src="images/instituto.jpeg" alt="Matrícula curso 2023 / 2024" />
                            <div className="card-body">
