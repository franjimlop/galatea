...
import NovedadesPlastica from '../components/novedades/novedadesPlastica';
    ...
    return (
        <div className='fondo'>
            <div className="container text-center pt-3">
                ...
                {enlaces.filter(enlace => enlace.departamento === 'plastica').length > 0 && (
                    <div className="py-3">
                        <h3>Enlaces de interés:</h3>
                        <ul className='documentos-ul'>
                            {enlaces.filter(enlace => enlace.departamento === 'plastica').map(enlace => (
