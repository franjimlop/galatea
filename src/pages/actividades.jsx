...
const GestionActividades = () => {
    ...
    const handleBorrarNoticiaSubmit = async (e) => {
        ...
        if (!noticiaSeleccionada) {
            toast.info('Por favor, selecciona una actividad para borrar', {
                position: "top-right",
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
        ...
        try {
            ...
            if (response.ok) {
                toast.success('Actividad borrada exitosamente', {
                    position: "top-right",
                    autoClose: 5000,
                    hideProgressBar: false,
                    closeOnClick: true,
                ...
                toast.error('Fallo al borrar actividad', {
                    position: "top-right",
                    autoClose: 5000,
                    hideProgressBar: false,
                    closeOnClick: true,
            ...
            <div className="py-5">
                <div className="login-container">
                    ...
                    <form encType="multipart/form-data" onSubmit={handleCrearNoticiaSubmit}>
                        ...
                        <input type="text" id="texto" name="texto" value={texto} onChange={handleTextoChange}/>
                        {textoError && <p className="error-message red">{textoError}</p>}
                        
                        <label htmlFor="categoria">Seleccionar Categoría Actividad:</label>
                        <select name="categoria" id="categoria" value={categoria} onChange={handleCategoriaChange}>
                            ...
                            <option value="extraescolar">Actividad Extraescolar</option>
                            <option value="complementaria">Actividad Complementaria</option>
                        </select>
            ...
            <div className="py-5">
                <div className="login-container">
                    ...
                    <form encType="multipart/form-data" onSubmit={handleCrearAdjuntoSubmit}>
                        <label htmlFor="noticia">Seleccionar Actividad:</label>
